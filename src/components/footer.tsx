    ...
    <div className="footer">
        <div className='container footer_area'>
            <div className="footer_logo">
                <svg className="footer-logo" xmlns="http://www.w3.org/2000/svg" width="139" height="20">
                    <defs>
            ...
            <div className='footer_menu_col1'>
                <a href="#">About Us</a>
                <a  href="#">Contact</a>
                <a  href="#">Blog</a>
            </div>

            <div className='footer_menu_col2'>
                <a  href="#">Careers</a>
                <a  href="#">Support</a> 
            ...
            <div className="attribution">
                ...
                <p>Coded by <a href="#">Evelyn Matos</a>.</p>
            </div>
        </div>
    </div>
  )
